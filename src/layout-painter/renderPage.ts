...
function computeOptionsHash(options: RenderPageOptions): string {
  ...
  if (options.headerContent) {
    parts.push(
      ...
      },${options.headerContent.visualBottom ?? options.headerContent.height},${hfTextFingerprint(options.headerContent)}`
    );
  }
  if (options.footerContent) {
    parts.push(
      ...
      },${options.footerContent.visualBottom ?? options.footerContent.height},${hfTextFingerprint(options.footerContent)}`
    );
  }
