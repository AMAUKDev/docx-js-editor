 ...
 * Comment Serializer
 *
 * Serializes Comment[] to OOXML comments.xml and comment extension parts.
 *
 ...
 * commentsIds.xml: stable durable IDs for Word Online reply support
 * commentsExtensible.xml: UTC timestamps for Pages and Word 2016+
 *
...
export function serializeCommentsExtensible(
  ...
  for (const info of paraInfos) {
    ...
    // Ensure UTC format — strip milliseconds and ensure Z suffix
